...
//      email, // Add email field (optional)
//      dateOfBirth, // Add dateOfBirth field (optional)
//      reasonForVisit, // Add reasonForVisit field
...
//   return (
//     <div className="w-full px-4 lg:px-32 py-4 h-full">
//       <h1 className="text-3xl font-bold text-gray-600 mb-4">
//         Book Your Appointment – Fast, Easy & Secure
//       </h1>
...
//       </p>
//       <div className=" w- h-full mx-auto p-4 bg-white shadow-md rounded-lg">
