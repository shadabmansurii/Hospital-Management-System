    ...
    <div className="w-full h-full  p-4 bg-gray-50">
      ...
      <div className="grid grid-col-1 md:grid-cols-2 gap-6">
        {data.map((room) => (
          <div
            key={room._id}
            className="w-full h-fit flex flex-col gap-2 md:gap-4 p-2 sm:p-4 md:p-6 shadow-lg rounded-lg bg-gradient-to-r from-purple-50 to-green-50 hover:shadow-xl transition-all"
          >
            <div className=" w-full text-gray-700 flex flex-col bg-purple-50 border border-purple-400 rounded-lg p-4 md:p-6">
              <span className="text-lg md:text-2xl font-bold md:mb-2 flex items-center gap-2">
                <RiHospitalLine className="text-purple-500" /> Room no:{" "}
                {room.roomNumber}
              </span>
              <p className="flex items-center text-xs sm:text-sm md:text-lg gap-2">
            ...
            {/* Bed Info Section */}
            <div className="w-full h-[20vh] md:h-[30vh] overflow-y-scroll bg-green-50 border shadow-inner border-green-400 rounded-lg p-4 md:p-6">
              <div className="flex justify-between items-center">
                <strong className="font-semibold text-sm md:text-lg text-gray-600">
                ...
                {room.beds.map((bed, index) => (
                  ...
                  >
                    <div
                      ...
                      } w-8 h-8 text-sm md:text-base sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg flex items-center justify-center transition-all`}
                    >
